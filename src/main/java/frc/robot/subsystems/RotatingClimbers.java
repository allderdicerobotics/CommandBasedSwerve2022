...
public class RotatingClimbers extends SubsystemBase {
  ...
  private final CANSparkMax leftRotatingClimber = new CANSparkMax(
    Constants.ClimberConstants.leftRotatingClimberPort,
    MotorType.kBrushless
  );
  private final CANSparkMax rightRotatingClimber = new CANSparkMax(
    Constants.ClimberConstants.rightRotatingClimberPort,
    MotorType.kBrushless
  );

  private final MotorControllerGroup rotatingClimberGroup = new MotorControllerGroup(
    leftRotatingClimber,
  ...
  public boolean atSetpoint() {
    ...
    double rightCurrentPosition = rightRotatingClimber
      .getEncoder()
      .getPosition();
    double rightError = Math.abs(this.currentSetpoint - rightCurrentPosition);
    return (
      leftError < ClimberConstants.rotatingPIDTolerance &&
