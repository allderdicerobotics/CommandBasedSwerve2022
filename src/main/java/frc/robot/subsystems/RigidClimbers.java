...
public class RigidClimbers extends SubsystemBase {
  ...
  private final CANSparkMax leftRigidClimber = new CANSparkMax(
    Constants.ClimberConstants.leftRigidClimberPort,
    MotorType.kBrushless
  );
  private final CANSparkMax rightRigidClimber = new CANSparkMax(
    Constants.ClimberConstants.rightRigidClimberPort,
    MotorType.kBrushless
  );

  private final MotorControllerGroup rigidClimberGroup = new MotorControllerGroup(
    leftRigidClimber,
    rightRigidClimber
  );
  ...
  public boolean atSetpoint() {
    ...
    return (
      leftError < ClimberConstants.rigidPIDTolerance &&
  ...
  public void setPosition(double desiredPosition) {
    ...
    leftRigidClimber
      .getPIDController()
      .setReference(desiredPosition - leftMotorOffset, ControlType.kPosition);
    rightRigidClimber
      .getPIDController()
      .setReference(desiredPosition - rightMotorOffset, ControlType.kPosition);
  }
