...
public class SwerveModule {
   ...
   * @param turningEncoderChannel Analog channel for the steering motor.
   *                              ALSO ROTATION OFFSET
   */
  ...
  // public SwerveModule(int kfrontleftdrivemotorport, int kfrontleftturningmotorport,
  //     ThriftyEncoder thriftyEncoder) {
  // }
  ...
  public SwerveModuleState getState() {
    SmartDashboard.putNumber("Encoder Position" + this.m_turningMotor.getDeviceId(),
        m_turningEncoder.getPositionRadians());
    SmartDashboard.putNumber("Encoder Voltage" + this.m_turningMotor.getDeviceId(),
        m_turningEncoder.input.getVoltage());
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    final double turnOutput = m_turningPIDController.calculate(m_turningEncoder.getPositionRadians(),
